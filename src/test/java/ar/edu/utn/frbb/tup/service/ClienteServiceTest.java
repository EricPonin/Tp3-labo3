...
public class ClienteServiceTest {
    ...
    public void testClienteAlreadyExistsException() throws ClienteAlreadyExistsException {
        ...
        pepeRino.setNombre("Juan");
        pepeRino.setApellido("Perez");
    ...
    @Test
    public void testAgregarCuentasExitosamente() throws TipoCuentaAlreadyExistsException {
        Cliente pepeRino = new Cliente();
        pepeRino.setDni(26456439);
        pepeRino.setNombre("juan");
        pepeRino.setApellido("Perez");
        ...
        // Agregar CAU$S
        clienteService.agregarCuenta(cuentaCAU, pepeRino.getDni());

        verify(clienteDao, times(3)).save(pepeRino);
        assertEquals(3, pepeRino.getCuentas().size());
        assertEquals(pepeRino, cuentaCA.getTitular());
        assertEquals(pepeRino, cuentaCC.getTitular());
        assertEquals(pepeRino, cuentaCAU.getTitular());
    }
    ...
    public void testBuscarClientePorDniExistente() {
        ...
        assertEquals(pepeRino.getDni(), clienteEncontrado.getDni());
        assertEquals(pepeRino.getNombre(), clienteEncontrado.getNombre());
        assertEquals(pepeRino.getApellido(), clienteEncontrado.getApellido());
    }
